...
import { Store, MessageSquare, ShoppingCart, Wallet } from "lucide-react";
import "./_group.css";
...
function useLocation(): [string] {
  return ["/e/cafe-kamba/dono/conversas"];
}
...
export function CurrentOwnerNav() {
  return (
    <div className="flex h-full min-h-[100dvh] flex-col" style={{ background: "var(--bg)" }}>
