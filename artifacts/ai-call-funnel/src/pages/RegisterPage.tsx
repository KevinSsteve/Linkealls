...
// ─── shared PIN dots + keypad (copied to avoid coupling) ────────────────────
        ...
        <div key={i} className="flex items-center gap-2">
          <div className="flex flex-col items-center gap-1">
            ...
            <span
              ...
              style={{ color: i <= current ? "#00BFA5" : "#4A6B80" }}
            >
              {label}
            </span>
          </div>
          {i < STEPS.length - 1 && (
            <div
              ...
              style={{
                background: i < current ? "#00BFA5" : "rgba(255,255,255,0.08)",
                width: 32,
              }}
            />
          )}
...
export function RegisterPage() {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={back}
        className="mb-6 w-9 h-9 flex items-center justify-center rounded-full"
        ...
        <>
          <input
            ...
            style={{
              ...
              color: "#EAF0F7", caretColor: "#60A5FA",
            }}
          ...
          <button
            ...
            style={{ background: "#60A5FA", color: "#050D14" }}
          >
            Continuar
          </button>
        </>
      ...
      {isPinStep && (
        <div className="flex flex-col items-center">
          ...
          {loading
            ? (
              <p className="text-[13px] mb-6 flex items-center gap-2" style={{ color: "#00BFA5" }}>
